...
class ThrusterControlModal extends Component {
  ...
  press = () => {
    ...
    if (totalCoins >= this.costs[this.state.level]) {
      ...
      Storage.setThrusterControlLevel(level)
  ...
  openModal = () => {
    ...
    Storage.getCoins().then(totalCoins => {
      Storage.getThrusterControlLevel().then(level => {
  ...
  render () {
    const level2Empty = <Image style={{ width: '5%', height: '7.5%', position: 'absolute', top: '76.25%', right: '74.75%' }} source={require('../assets/thruster-control-box-empty.png')} />
    const level3Empty = <Image style={{ width: '5%', height: '7.5%', position: 'absolute', top: '76.25%', right: '68.75%' }} source={require('../assets/thruster-control-box-empty.png')} />
    const level4Empty = <Image style={{ width: '5%', height: '7.5%', position: 'absolute', top: '76.25%', right: '62.75%' }} source={require('../assets/thruster-control-box-empty.png')} />
    const level5Empty = <Image style={{ width: '5%', height: '7.5%', position: 'absolute', top: '76.25%', right: '56.75%' }} source={require('../assets/thruster-control-box-empty.png')} />

    const level1Filled = <Image style={{ width: '6%', height: '7.5%', position: 'absolute', top: '76.25%', right: '80.75%' }} source={require('../assets/thruster-control-box-filled.png')} />
    const level2Filled = <Image style={{ width: '6%', height: '7.5%', position: 'absolute', top: '76.25%', right: '74.75%' }} source={require('../assets/thruster-control-box-filled.png')} />
    const level3Filled = <Image style={{ width: '6%', height: '7.5%', position: 'absolute', top: '76.25%', right: '68.75%' }} source={require('../assets/thruster-control-box-filled.png')} />
    const level4Filled = <Image style={{ width: '6%', height: '7.5%', position: 'absolute', top: '76.25%', right: '62.75%' }} source={require('../assets/thruster-control-box-filled.png')} />
    const level5Filled = <Image style={{ width: '6%', height: '7.5%', position: 'absolute', top: '76.25%', right: '56.75%' }} source={require('../assets/thruster-control-box-filled.png')} />
