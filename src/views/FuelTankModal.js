...
class FuelTankModal extends Component {
  constructor () {
    super()
    this.state = {
      modalVisible: false,
  ...
  openModal = () => {
    ...
    Storage.getCoins().then(totalCoins => {
      Storage.getFuelLevel().then(level => {
  ...
  render () {
    const level2Empty = <Image style={{ width: '5%', height: '7.5%', position: 'absolute', top: '76.25%', right: '74.75%' }} source={require('../assets/fuel-tank-box-empty.png')} />
    const level3Empty = <Image style={{ width: '5%', height: '7.5%', position: 'absolute', top: '76.25%', right: '68.75%' }} source={require('../assets/fuel-tank-box-empty.png')} />
    const level4Empty = <Image style={{ width: '5%', height: '7.5%', position: 'absolute', top: '76.25%', right: '62.75%' }} source={require('../assets/fuel-tank-box-empty.png')} />
    const level5Empty = <Image style={{ width: '5%', height: '7.5%', position: 'absolute', top: '76.25%', right: '56.75%' }} source={require('../assets/fuel-tank-box-empty.png')} />

    const level1Filled = <Image style={{ width: '6%', height: '7.5%', position: 'absolute', top: '76.25%', right: '80.75%' }} source={require('../assets/fuel-tank-box-filled.png')} />
    const level2Filled = <Image style={{ width: '6%', height: '7.5%', position: 'absolute', top: '76.25%', right: '74.75%' }} source={require('../assets/fuel-tank-box-filled.png')} />
    const level3Filled = <Image style={{ width: '6%', height: '7.5%', position: 'absolute', top: '76.25%', right: '68.75%' }} source={require('../assets/fuel-tank-box-filled.png')} />
    const level4Filled = <Image style={{ width: '6%', height: '7.5%', position: 'absolute', top: '76.25%', right: '62.75%' }} source={require('../assets/fuel-tank-box-filled.png')} />
    const level5Filled = <Image style={{ width: '6%', height: '7.5%', position: 'absolute', top: '76.25%', right: '56.75%' }} source={require('../assets/fuel-tank-box-filled.png')} />
    ...
    return (
      <Fragment>
            ...
            <TouchableWithoutFeedback>
              <View style={styles.modalContainer}>
                <View style={styles.symbolBox}>
                  <Image style={styles.symbol} source={require('../assets/fuel-tank-symbol.png')} />
                </View>
                <View style={styles.upgradeNameBox}>
                  <Text style={styles.fuelTank}>FUEL TANK</Text>
                </View>
                <View style={styles.textBox}>
                  <Text style={styles.description}>
                    {[
                      'Increases the ships initial distance traveled'
                    ]}
                  </Text>
                </View>
        ...
        <TouchableOpacity onPress={ () => { this.openModal() }}>
          <Image style={styles.FTbutton} source={require('../assets/up-fuel-tank.png')} />
        </TouchableOpacity>
      </Fragment>
    )
  }
